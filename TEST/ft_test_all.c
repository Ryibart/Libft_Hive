...
/*   Updated: 2024/04/28 15:36:24 by rtammi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char map_to_upper(unsigned int index, char c) {
    (void)index; // Ignore the index parameter for simplicity
    return toupper(c);
}
...
void test_ft_memset()
{
    ...
    ft_memset(buffer_custom, '7', 9);
    memset(buffer_std, '7', 9);
    printf("Custom: %s, Std: %s (Expected: 777777777)\n", buffer_custom, buffer_std);
}
...
void test_ft_strlcpy()
{
    ...
    printf("Custom: %lu, std: %lu (Expected: 13)\n", ft_strlcpy(dest_custom, "Hello, World!", 20), strlcpy(dest_std, "Hello, World!", 20));
...
void test_ft_strlcat()
{
    ...
    printf("Custom: %lu, std: %lu (Expected: 11)\n", ft_strlcat(dest_custom, " World", 20), strlcat(dest_std, " World", 20));
    printf("Custom: %s, std: %s (Expected: Hello World)\n", dest_custom, dest_std);
}
...
void test_ft_atoi() {
    ...
    printf("ft_atoi(\"123\"): %d, atoi(\"123\"): %d (Expected: 123)\n", ft_result, std_result);
    ...
    // Overflow handling (should mimic standard behavior)
    ft_result = ft_atoi("9223372036854775807");
    std_result = atoi("9223372036854775807");
    printf("ft_atoi(\"9223372036854775807\"): %d, atoi(\"9223372036854775807\"): %d (Expected: -1)\n", ft_result, std_result);

    ft_result = ft_atoi("-9223372036854775808");
    std_result = atoi("-9223372036854775808");
    printf("ft_atoi(\"-9223372036854775808\"): %d, atoi(\"-9223372036854775808\"): %d (Expected: 0)\n", ft_result, std_result);

    // Mixed valid and invalid characters
    ft_result = ft_atoi("123abc");
    std_result = atoi("123abc");
    printf("ft_atoi(\"123abc\"): %d, atoi(\"123abc\"): %d (Expected: 123)\n", ft_result, std_result);

    // Invalid strings
    ft_result = ft_atoi("abc123");
    std_result = atoi("abc123");
    printf("ft_atoi(\"abc123\"): %d, atoi(\"abc123\"): %d (Expected: 0)\n", ft_result, std_result);

    ft_result = ft_atoi(" ");
    std_result = atoi(" ");
    printf("ft_atoi(\" \"): %d, atoi(\" \"): %d (Expected: 0)\n", ft_result, std_result);
...
void test_ft_strmapi() {
    ...
    char *mapped_str = ft_strmapi(original, map_to_upper);

    printf("Original string: %s\n", original);
    printf("Mapped string: %s (Expected: HELLO)\n", mapped_str);
